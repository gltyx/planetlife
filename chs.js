...
var cnItems = {
    ...
    "Psst! Burger is telling you a secret.\n The asteroid is actually a giant Coco Pops. What a revelation!": "嘘!汉堡告诉你一个秘密。\n这颗小行星实际上是一个巨大的可可棒棒糖。这是什么启示啊!",
    "Hear news": "听新闻",
    "Show me": "给我看看",
    "Burger tells you that it has found a strange valley while working. It seems to be riddled with ancient dungeon entrances..": "汉堡告诉你，它在工作时发现了一个奇怪的山谷。它似乎布满了古老的地牢入口…",
    ...
    "Dungeons": "地牢",
    "Hear good news": "听好消息",
    "Right now Burger has a": "现在汉堡有一个",
    "of mining": "开采",
    "Gold drill upgraded!": "黄金钻头已升级！",
    "Good enough gold drill": "足够好的黄金钻头",
    "Burger seems in a particularly good mood today. It shows you a handfuld of some glittery stuff.": "汉堡今天看起来心情特别好。它向你展示了一些闪闪发光的东西。",
    "Burger tells you that it won it on the slot machine. You should give it a try!": "汉堡告诉你它是在游戏机上赢的。你应该试试!",
